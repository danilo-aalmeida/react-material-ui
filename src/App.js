...
import { Paper, Typography, Grid, Card, CardHeader, CardContent, Avatar, List, 
  ...
  const list = [
    { id: 1, name: "Danilo", text: "Olá, tudo bem?", image: <ImageIcon /> },
    { id: 2, name: "Pedro", text: "Lorem ipsum", image: <WorkIcon /> },
    { id: 3, name: "Ronaldo", text: "Lorem ipsum", image: <BeachAccessIcon /> }
  ];
